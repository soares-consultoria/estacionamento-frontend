    ...
    return (
      <div className="w-full min-h-screen bg-white sm:bg-slate-100 sm:flex sm:items-center sm:justify-center sm:p-4">
        <div className="w-full sm:max-w-sm sm:bg-white sm:rounded-2xl sm:shadow-sm sm:border sm:border-slate-100 p-6 py-10 sm:p-8 text-center">
          ...
          <div className="bg-red-50 border border-red-200 text-red-700 rounded-lg px-4 py-4 text-sm mb-6">
            Link inválido ou expirado. Solicite um novo link de redefinição de senha.
          </div>
          <Link
            to="/esqueci-senha"
            className="inline-block w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3.5 rounded-lg text-base transition-colors text-center"
          >
            Solicitar novo link
          </Link>
          <div className="mt-4">
  ...
  return (
    <div className="w-full min-h-screen bg-white sm:bg-slate-100 sm:flex sm:items-center sm:justify-center sm:p-4">
      <div className="w-full sm:max-w-sm sm:bg-white sm:rounded-2xl sm:shadow-sm sm:border sm:border-slate-100 p-6 py-10 sm:p-8">
        ...
        <p className="text-slate-400 text-sm mb-6">Cadastre uma nova senha para sua conta.</p>
